        ...
        <div class="content">
          <div class="tabs">
            <button
              ...
              @click=${()=>{this._mode!=="time"&&(this._editingUid="",this._mode="time")}}
            >
              Time
            </button>
            <button
              class="tab ${this._mode==="location"?"active":""}"
              @click=${()=>{this._mode!=="location"&&(this._editingUid="",this._mode="location")}}
            >
              Location
            </button>
          </div>
