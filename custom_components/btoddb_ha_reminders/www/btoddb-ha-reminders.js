...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Te=/'/g,Se=/"/g,Me=/^(?:script|style|textarea|title)$/i,oe=s=>(t,...e)=>({_$litType$:s,strings:t,values:e}),h=oe(1),ft=oe(2),yt=oe(3),C=Symbol.for("lit-noChange"),u=Symbol.for("lit-nothing"),De=new WeakMap,E=x.createTreeWalker(x,129);function Pe(s,t){if(!ae(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return xe!==void 0?xe.createHTML(t):t}var Xe=(s,t)=>{let e=s.length-1,i=[],r,n=t===2?"<svg>":t===3?"<math>":"",a=M;for(let d=0;d<e;d++){let o=s[d],c,m,p=-1,l=0;for(;l<o.length&&(a.lastIndex=l,m=a.exec(o),m!==null);)l=a.lastIndex,a===M?m[1]==="!--"?a=Ce:m[1]!==void 0?a=Ae:m[2]!==void 0?(Me.test(m[2])&&(r=RegExp("</"+m[2],"g")),a=w):m[3]!==void 0&&(a=w):a===w?m[0]===">"?(a=r??M,p=-1):m[1]===void 0?p=-2:(p=a.lastIndex-m[2].length,c=m[1],a=m[3]===void 0?w:m[3]==='"'?Se:Te):a===Se||a===Te?a=w:a===Ce||a===Ae?a=M:(a=w,r=void 0);let g=a===w&&s[d+1].startsWith("/>")?" ":"";n+=a===M?o+Qe:p>=0?(i.push(c),o.slice(0,p)+ke+o.slice(p)+$+g):o+$+(p===-2?d:g)}return[Pe(s,n+(s[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),i]},H=class s{constructor({strings:t,_$litType$:e},i){let r;this.parts=[];let n=0,a=0,d=t.length-1,o=this.parts,[c,m]=Xe(t,e);if(this.el=s.createElement(c,i),E.currentNode=this.el.content,e===2||e===3){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(r=E.nextNode())!==null&&o.length<d;){if(r.nodeType===1){if(r.hasAttributes())for(let p of r.getAttributeNames())if(p.endsWith(ke)){let l=m[a++],g=r.getAttribute(p).split($),v=/([.?@])?(.*)/.exec(l);o.push({type:1,index:n,name:v[2],strings:g,ctor:v[1]==="."?te:v[1]==="?"?ie:v[1]==="@"?re:T}),r.removeAttribute(p)}else p.startsWith($)&&(o.push({type:6,index:n}),r.removeAttribute(p));if(Me.test(r.tagName)){let p=r.textContent.split($),l=p.length-1;if(l>0){r.textContent=q?q.emptyScript:"";for(let g=0;g<l;g++)r.append(p[g],P()),E.nextNode(),o.push({type:2,index:++n});r.append(p[l],P())}}}else if(r.nodeType===8)if(r.data===Re)o.push({type:2,index:n});else{let p=-1;for(;(p=r.data.indexOf($,p+1))!==-1;)o.push({type:7,index:n}),p+=$.length-1}n++}}static createElement(t,e){let i=x.createElement("template");return i.innerHTML=t,i}};function A(s,t,e=s,i){if(t===C)return t;let r=i!==void 0?e._$Co?.[i]:e._$Cl,n=L(t)?void 0:t._$litDirective$;return r?.constructor!==n&&(r?._$AO?.(!1),n===void 0?r=void 0:(r=new n(s),r._$AT(s,e,i)),i!==void 0?(e._$Co??=[])[i]=r:e._$Cl=r),r!==void 0&&(t=A(s,r._$AS(s,t.values),r,i)),t}var ee=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:i}=this._$AD,r=(t?.creationScope??x).importNode(e,!0);E.currentNode=r;let n=E.nextNode(),a=0,d=0,o=i[0];for(;o!==void 0;){if(a===o.index){let c;o.type===2?c=new N(n,n.nextSibling,this,t):o.type===1?c=new o.ctor(n,o.name,o.strings,this,t):o.type===6&&(c=new se(n,this,t)),this._$AV.push(c),o=i[++d]}a!==o?.index&&(n=E.nextNode(),a++)}return E.currentNode=x,r}p(t){let e=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}},N=class s{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,r){this.type=2,this._$AH=u,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=A(this,t,e),L(t)?t===u||t==null||t===""?(this._$AH!==u&&this._$AR(),this._$AH=u):t!==this._$AH&&t!==C&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Je(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==u&&L(this._$AH)?this._$AA.nextSibling.data=t:this.T(x.createTextNode(t)),this._$AH=t}$(t){let{values:e,_$litType$:i}=t,r=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=H.createElement(Pe(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===r)this._$AH.p(e);else{let n=new ee(r,this),a=n.u(this.options);n.p(e),this.T(a),this._$AH=n}}_$AC(t){let e=De.get(t.strings);return e===void 0&&De.set(t.strings,e=new H(t)),e}k(t){ae(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,i,r=0;for(let n of t)r===e.length?e.push(i=new s(this.O(P()),this.O(P()),this,this.options)):i=e[r],i._$AI(n),r++;r<e.length&&(this._$AR(i&&i._$AB.nextSibling,r),e.length=r)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){let i=Ee(t).nextSibling;Ee(t).remove(),t=i}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},T=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,r,n){this.type=1,this._$AH=u,this._$AN=void 0,this.element=t,this.name=e,this._$AM=r,this.options=n,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=u}_$AI(t,e=this,i,r){let n=this.strings,a=!1;if(n===void 0)t=A(this,t,e,0),a=!L(t)||t!==this._$AH&&t!==C,a&&(this._$AH=t);else{let d=t,o,c;for(t=n[0],o=0;o<n.length-1;o++)c=A(this,d[i+o],e,o),c===C&&(c=this._$AH[o]),a||=!L(c)||c!==this._$AH[o],c===u?t=u:t!==u&&(t+=(c??"")+n[o+1]),this._$AH[o]=c}a&&!r&&this.j(t)}j(t){t===u?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},te=class extends T{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===u?void 0:t}},ie=class extends T{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==u)}},re=class extends T{constructor(t,e,i,r,n){super(t,e,i,r,n),this.type=5}_$AI(t,e=this){if((t=A(this,t,e,0)??u)===C)return;let i=this._$AH,r=t===u&&i!==u||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,n=t!==u&&(i===u||r);r&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},se=class{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){A(this,t)}};var et=ne.litHtmlPolyfillSupport;et?.(H,N),(ne.litHtmlVersions??=[]).push("3.3.3");var Le=(s,t,e)=>{let i=e?.renderBefore??t,r=i._$litPart$;if(r===void 0){let n=e?.renderBefore??null;i._$litPart$=r=new N(t.insertBefore(P(),n),n,void 0,e??{})}return r._$AI(s),r};var de=globalThis,_=class extends y{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Le(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return C}};_._$litElement$=!0,_.finalized=!0,de.litElementHydrateSupport?.({LitElement:_});var tt=de.litElementPolyfillSupport;tt?.({LitElement:_});(de.litElementVersions??=[]).push("4.2.2");var le="calendar.btoddb_reminders",B=14,ce="/calendar?view=dayGridMonth",he=365,He=6e4,Ne="btoddb-ha-reminders-reminders-changed";function V(s,t,e,i){let r=Number(s);return Number.isFinite(r)?Math.max(e,Math.min(i,Math.floor(r))):t}function U(s,t){return s===!0?"always":s===!1?"never":s==="always"||s==="never"||s==="auto"?s:t}function pe(s,t){return s===!0?"always":s===!1?"never":s==="always"||s==="never"||s==="auto"?s:t}function it(s){return typeof s!="string"?ce:s.trim()||ce}function rt(s){let[t,e,i]=s.split("-").map(Number);return new Date(t,e-1,i)}function Oe(s){if(!s)return null;if(s.dateTime){let t=new Date(s.dateTime);return Number.isNaN(t.getTime())?null:t}return s.date?rt(s.date):null}function f(s){return`${s.getFullYear()}-${s.getMonth()}-${s.getDate()}`}function Ie(s){let t=new Date(s);return t.setHours(0,0,0,0),t}function Ue(s){let t=new Date(s);return t.setDate(t.getDate()+1),t}function ze(s){let t=new Date(s);return t.setDate(t.getDate()-1),t}function st(s,t){return s.getTime()>t.getTime()?s:t}function nt(s,t){return s.getTime()<t.getTime()?s:t}function at(s,t){return!t||t.getTime()<=s.getTime()?s:new Date(t.getTime()-1)}function ot(s){let t=new Set;return s.filter(e=>{let i=`${e.dedupeKey}|${f(e.displayDate)}`;return t.has(i)?!1:(t.add(i),!0)})}var O=class extends _{constructor(){super(...arguments);this._config={type:""}}setConfig(e){this._config=e??{type:""}}_entities(){let e=this._config.entities;return e?e.map(i=>typeof i=="string"?i:i.entity).filter(i=>!!i):[le]}_fireConfigChanged(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}_titleChanged(e){let i=e.target.value;this._fireConfigChanged({...this._config,title:i})}_dashboardPathChanged(e){let i=e.target.value.trim();this._fireConfigChanged({...this._config,dashboard_path:i||void 0})}_daysChanged(e){let i=V(e.target.value,B,1,he);this._fireConfigChanged({...this._config,days:i})}_maxItemsChanged(e){let i=V(e.target.value,0,0,500);this._fireConfigChanged({...this._config,max_items:i})}_hideEndTimeChanged(e){let i=U(e.target.value,"auto");this._fireConfigChanged({...this._config,hide_end_time:i})}_showCalendarNameChanged(e){let i=pe(e.target.value,"auto");this._fireConfigChanged({...this._config,show_calendar_name:i})}_entityChanged(e,i){let r=i.detail.value??"",n=this._entities();r?n[e]=r:e<n.length&&n.splice(e,1),this._fireConfigChanged({...this._config,entities:n})}_removeEntity(e){let i=this._entities();i.splice(e,1),this._fireConfigChanged({...this._config,entities:i})}render(){if(!this.hass||!this._config)return h``;let e=this._entities(),i=[...e,""],r=this._config.days??B,n=U(this._config.hide_end_time,"auto"),a=pe(this._config.show_calendar_name,"auto"),d=this._config.max_items??0;return h`
  ...
  `;customElements.define("btoddb-calendar-list-card",I);var dt="calendar.btoddb_reminders",lt="btoddb-ha-reminders-reminders-changed",ue="sensor.btoddb_location_reminders",We="btoddb_ha_reminders_location",ct=[{code:"SU",label:"S"},{code:"MO",label:"M"},{code:"TU",label:"T"},{code:"WE",label:"W"},{code:"TH",label:"T"},{code:"FR",label:"F"},{code:"SA",label:"S"}],Ye={MO:"Monday",TU:"Tuesday",WE:"Wednesday",TH:"Thursday",FR:"Friday",SA:"Saturday",SU:"Sunday"},ht={SU:0,MO:1,TU:2,WE:3,TH:4,FR:5,SA:6},Z=s=>String(s).padStart(2,"0");function ge(s){return`${s.getFullYear()}-${Z(s.getMonth()+1)}-${Z(s.getDate())}T${Z(s.getHours())}:${Z(s.getMinutes())}`}function me(){let s=new Date;return s.setHours(s.getHours()+1,0,0,0),ge(s)}var z=class extends _{constructor(){super(...arguments);this._config={type:""}}setConfig(e){this._config=e}_titleChanged(e){let i=e.target.value;this._fireConfigChanged({...this._config,title:i})}_entityChanged(e){let i=e.detail.value;this._fireConfigChanged({...this._config,entity:i})}_fireConfigChanged(e){this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}render(){return!this.hass||!this._config?h``:h`
      <div class="card-config">
        <input
          class="title-field"
          type="text"
