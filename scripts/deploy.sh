#!/usr/bin/env bash
# Build the BToddB HA Reminders Lovelace card and deploy it into the
# integration's www/ directory.
#
# The integration serves the card at /btoddb-ha-reminders/ and auto-registers
...
CARD_DIR="${HOME_DIR}/custom_components/btoddb_ha_reminders/card"
...
cp btoddb-ha-reminders.js btoddb-ha-reminders.js.map "$COMPONENT_WWW/"
